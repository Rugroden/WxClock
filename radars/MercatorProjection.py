...
class MercatorProjection:
    ...
    def __init__(self):
        self.pixelOrigin_ = Point(Utils.MERCATOR_RANGE / 2.0, Utils.MERCATOR_RANGE / 2.0)
        self.pixelsPerLonDegree_ = Utils.MERCATOR_RANGE / 360.0
        self.pixelsPerLonRadian_ = Utils.MERCATOR_RANGE / (2.0 * math.pi)
